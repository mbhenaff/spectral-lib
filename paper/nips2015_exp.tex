...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.7\textwidth]{{merck}.pdf}
...
\hline
- &FC4000-FC2000-FC1000-FC1000 & $22.1 \cdot 10^6$ & 0.2729 \\
Supervised & GC16-P4-GC16-P4-FC1000-FC1000 & $3.8\cdot 10^6$ & 0.2773 \\
Supervised & GC64-P8-GC64-P8-FC1000-FC1000 & $3.8\cdot 10^6$ & 0.2580 \\
RBF Kernel & GC64-P8-GC64-P8-FC1000-FC1000 & $3.8\cdot 10^6$ & 0.2037 \\
RBF Kernel (local) & GC64-P8-GC64-P8-FC1000-FC1000 & $3.8\cdot 10^6$ & 0.1479 \\
\hline
\end{tabular}
\end{center}
\end{table}
...
\begin{figure}[h]
\centering
 \includegraphics[width=0.7\textwidth]{{imagenetcrop}.pdf}
